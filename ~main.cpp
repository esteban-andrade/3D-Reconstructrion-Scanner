...
//     ReconstructionMain.poissonReconstruction(smoothed_cloud, poisson_mesh);
//     //helper.convertPCLtoPLY(smoothed_cloud,"../Meshes/smoothed.ply");
//     //ReconstructionMain.normalsTesting(smoothed_cloud,smoothed_cloud_refined);
...
//     // viewer->addText("5 .Ref", 10, 10, 1, 1, 1, "ref text", v8);
//     // pcl::visualization::PointCloudColorHandlerRGBField<pcl::PointXYZRGBNormal> mesh8(cluster_ref_cloud);
//     // viewer->addPointCloud<PointXYZRGBNormal>(cluster_ref_cloud, "Pointcloud 8", v8);
//     // viewer->addPointCloudNormals<PointXYZRGBNormal>(cluster_ref_cloud, 10, 0.01f, "PointcloudNormal 8", v8);
//     // viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 3, "Pointcloud 8");
//     // viewer->createViewPortCamera(v8);

//     // viewer->createViewPort(0.67, 0.5, 1, 1, v8);
//     // viewer->setBackgroundColor(0, 0, 0, v8);
//     // viewer->addText("5. GREEN-> SCALED PCL", 10, 10, 1, 1, 1, "v8A text", v8);
//     // pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBNormal> mesh8a(cloud_segmented_and_clusterized_filtered_new, 0, 255, 0);
//     // viewer->addPointCloud<PointXYZRGBNormal>(cloud_segmented_and_clusterized_filtered_new, mesh8a, "Pointcloud 8a", v8);
...
//     // pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBNormal> mesh8b(meshes_processing_scale_alignment.at(1), 255, 0, 0);
//     // viewer->addPointCloud<PointXYZRGBNormal>(meshes_processing_scale_alignment.at(1), mesh8b, "Pointcloud 8b", v8);
...
//     // viewer->addText("5. GREEN-> SCALED PCL", 10, 10, 1, 1, 1, "vA text", v5);
//     // pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBNormal> mesha(cloud_aligned_new, 0, 255, 0);
//     // viewer->addPointCloud<PointXYZRGBNormal>(cloud_aligned_new, mesha, "Pointcloud a", v5);
//     // viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 3, "Pointcloud a");

//     // viewer->addText("5. RED-> REFERENCE PCL", 10, 1, 1, 1, 1, "vb text", v5);
//     // pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBNormal> meshb(meshes_scale.at(1), 255, 0, 0);
//     // viewer->addPointCloud<PointXYZRGBNormal>(meshes_scale.at(1), meshb, "Pointcloud b", v5);
//     // viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 3, "Pointcloud b");
...
//     viewer->setBackgroundColor(0, 0, 0, v8);
//     viewer->addText("5. GREEN-> SCALED PCL", 10, 10, 1, 1, 1, "v8A text", v8);
//     pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBNormal> mesh8a(cloud_aligned_new, 0, 255, 0);
//     viewer->addPointCloud<PointXYZRGBNormal>(cloud_aligned_new, mesh8a, "Pointcloud 8a", v8);
//     viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 3, "Pointcloud 8a");

//     viewer->addText("5. RED-> REFERENCE PCL", 10, 1, 1, 1, 1, "v8b text", v8);
//     pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBNormal> mesh8b(meshes_scale.at(1), 255, 0, 0);
//     viewer->addPointCloud<PointXYZRGBNormal>(meshes_scale.at(1), mesh8b, "Pointcloud 8b", v8);
//     viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 3, "Pointcloud 8b");
...
//     pcl::visualization::PointCloudColorHandlerRGBField<pcl::PointXYZRGBNormal> mesh5(smoothed_cloud);
//     viewer->addPointCloud<PointXYZRGBNormal>(smoothed_cloud, "Pointcloud 5", v5);
//     viewer->addPointCloudNormals<PointXYZRGBNormal>(smoothed_cloud, 10, 0.05f, "PointcloudNormals 5", v5);
